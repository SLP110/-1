  ...
  <section class="index">
        ...
        <div class="coupon-con">
            <div class="coupon-item" v-for="(v, index) in couponList" :key="index">
                <div class="coupon-item-left">
                    <img class="coupon-icon" :src="v.logo_photo" mode="aspectFill">
                </div>
    ...
    <div class="nav-con" v-show="navSelect == 2">
        <div class="top-con">
            ...
            <div class="user-info">
                <div class="outter">
                  <img  mode="aspectFill" class="user-img" :src="userInfo.head_img">
                </div>
                <div class="user-name">
                    {{userInfo.nickname}}
                </div>
    ...
    <div class="bottom-panel animated" :class="{'fadeOutDown': panelShow == 1, 'fadeInUp': panelShow == 2}" catchtouchmove='true'>
      <div class="shop-icon-outter"> 
        <div class="shop-icon-inner">
            <img :src="couponObject.logo_photo" mode="aspectFill" class="shop-icon">
        </div>
      </div>
      <div class="close-con">
        ...
        <div class="list-cell">
          <div class="list-cell-left">
            <div class="list-cell-img">
              <img :src="couponObject.g_photo" mode="aspectFill">
            </div>
