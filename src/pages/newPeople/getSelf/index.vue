<template>
  <section class="getSelf">
    ...
    <div class="second">
        <img class="bg" src="../../../common/img/me/img_new_red_envelopes_bg_3.png" mode="widthFix">
        <div class="input-con">
            <div class="user-img">
            ...
            <div class="tips">不能领取自己的红包哦</div>
            <button class="btn-share" open-type="share">邀请好友领取赚{{returnMoney}}元</button>
        </div>
    </div>
    <div class="third">
        <img class="bg" src="../../../common/img/me/img_new_red_envelopes_3.png" mode="widthFix">
